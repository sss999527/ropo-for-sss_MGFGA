...
def load_mnist(base_path):
    print(base_path)
    # mnist_data = loadmat(path.join(base_path, "dataset", "../dataset/DigitFive",
    #                                "../dataset/DigitFive/mnist_data.mat"))
...
def load_mnist_m(base_path):
    # mnistm_data = loadmat(path.join(base_path, "dataset", "../dataset/DigitFive",
    #                                 "../dataset/DigitFive/mnistm_with_label.mat"))
...
def load_svhn(base_path):
    # svhn_train_data = loadmat(path.join(base_path, "dataset", "../dataset/DigitFive",
    #                                     "../dataset/DigitFive/svhn_train_32x32.mat"))
    svhn_train_data = loadmat(path.join(base_path, "dataset/DigitFive/svhn_train_32x32.mat"))
    # svhn_test_data = loadmat(path.join(base_path, "dataset", "../dataset/DigitFive",
    #                                    "../dataset/DigitFive/svhn_test_32x32.mat"))
...
def load_syn(base_path):
    ...
    # syn_train_data = loadmat(path.join(base_path, "dataset", "../dataset/DigitFive",
    #                                    "../dataset/DigitFive/synth_train_32x32.mat"))
    syn_train_data = loadmat(path.join(base_path, "dataset/DigitFive/synth_train_32x32.mat"))
    print("load syn test")
    # syn_test_data = loadmat(path.join(base_path, "dataset", "../dataset/DigitFive",
    #                                   "../dataset/DigitFive/synth_test_32x32.mat"))
...
def load_usps(base_path):
    # usps_dataset = loadmat(path.join(base_path, "dataset", "../dataset/DigitFive",
    #                                  "../dataset/DigitFive/usps_28x28.mat"))
