...
parser.add_argument('--target-domain', type=str, default="mnist", help="The target domain we want to perform domain adaptation")
...
def main(args=args, configs=configs):
    ...
    if os.path.exists(writer_log_dir):
        flag = input("{} train_time_{} will be removed, input yes to continue:".format(
